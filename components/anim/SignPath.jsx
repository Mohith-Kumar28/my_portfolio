...
<motion.path
          ...
          transition={{
            ...
            repeatType: "loop",
            repeatDelay: 4
          }} d="M323.217 196.07C323.217 196.07 392.57 191.85 434.897 179.505C499.019 160.802 468.561 188.054 468.561 188.054" stroke="#C778DD" strokeWidth={strokeWidth} strokeLinecap="round" className="svg-elem-2"></motion.path>
<motion.path
            initial={{ pathLength: 0, pathOffset: 0 }}
            animate={{ pathLength: 1, pathOffset: 0 }}
            transition={{
              ...
              repeatType: "loop",
              repeatDelay: 4
            }} d="M334.973 398.589L338.179 402.864" stroke="#C778DD" strokeWidth={strokeWidth} strokeLinecap="round" className="svg-elem-3"></motion.path>
<motion.path
          initial={{ pathLength: 0, pathOffset: 0 }}
          animate={{ pathLength: 1, pathOffset: 0 }}
          transition={{   
            ...
            repeatType: "loop",
            repeatDelay: 4
          }} d="M386.805 379.352L391.08 383.093" stroke="#C778DD" strokeWidth={strokeWidth} strokeLinecap="round" className="svg-elem-4"></motion.path>
</svg>
          {/* </motion.div> */}
{/* </div> */}
    </>
