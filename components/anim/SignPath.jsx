...
const SignPath = () => {
  return (
    ...
    <div className='bg-pri-purple-dark h-screen overflow-hidden flex justify-center '>
        <motion.div initial={{opacity:0,scale:0.3}} whileInView={{opacity:0.1,scale:1}} transition={{duration:1, repeat: Infinity,
            repeatType: "loop",  repeatDelay: 1}} className='w-[40%]  border-pri-white rounded-xl flex  justify-center  p-4 -rotate-12'>
