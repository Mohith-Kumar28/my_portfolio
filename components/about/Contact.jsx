...
const Contact = () => {
  return (
    <div id="contact" className="p-6 my-6">
      ...
      <div className="flex flex-col-reverse md:flex md:flex-row">
        <div className="">
          <p className="text-pri-gray pb-8 md:pr-20">
            Feel free to reach out to me for job opportunities, freelance
            projects, or any other inquiries you may have. I am excited to hear
            from you and explore potential collaborations. Let us connect and
        ...
        <div className=" ">
          ...
          <Link href={"mailto:mohithkumar808@gmail.com"}>
            <div className="group font-bold text-center border-2  border-pri-purple shadow-2xl shadow-pri-purple/50 hover:border-pri-purple hover:bg-transparent bg-pri-purple text-xl  hover:text-pri-white p-4 mb-6">
              MAIL ME
              <div className="group-hover:text-pri-gray text-sm  md:text-base text-pri-black flex gap-2 justify-center">
